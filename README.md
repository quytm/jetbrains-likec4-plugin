...
<!-- Plugin description -->
This is a plugin for Jetbrains IDEs that demonstrates the usage of the
[@likec4/language-server](https://github.com/likec4/likec4/tree/main/packages/language-server)
(that based on [LSP API](https://plugins.jetbrains.com/docs/intellij/language-server-protocol.html))  
